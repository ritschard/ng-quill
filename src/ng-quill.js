...
(function () {
    ...
    app.provider('ngQuillConfig', function () {
        ...
        this.set = function (fontSizes, fontFamilies, fontColors, fontBgColors) {
            if (fontSizes) {
            ...
            if (fontBgColors) {
                config.fontBgColors = fontBgColors;
            }
        };
        ...
        function ($timeout, ngQuillService, ngQuillConfig) {
            return {
                ...
                link: function ($scope, element, attr, ngModel) {
                    ...
                    $scope.fontcolorOptions = $scope.fontcolorOptions || ngQuillConfig.fontColors;
                    $scope.fontbgcolorOptions = $scope.fontbgcolorOptions || ngQuillConfig.fontBgColors;
                        ...
                        '<div class="toolbar toolbar-container" ng-if="toolbar" ng-show="toolbarCreated && showToolbar">' +
                            ...
                            '<span class="ql-format-group" ng-if="shouldShow([\'color\', \'background\'])">' +
                                '<select title="{{dict.textColor}}" class="ql-color" ng-if="shouldShow([\'color\'])">' +
                                    '<option ng-repeat="option in fontcolorOptions" ng-selected="$index === 1" value="{{option}}"></option>' +
                                '</select>' +
                                '<select title="{{dict.backgroundColor}}" class="ql-background" ng-if="shouldShow([\'background\'])">' +
                                    '<option ng-repeat="option in fontbgcolorOptions" ng-selected="$index === 1" value="{{option}}"></option>' +
                                '</select>' +
                            '</span>' +
